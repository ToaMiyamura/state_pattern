...
# ビルド状態
[![MSBuild](https://github.com/ToaMiyamura/state_pattern/actions/workflows/msbuild.yml/badge.svg)](https://github.com/ToaMiyamura/state_pattern/actions/workflows/msbuild.yml)
...
質問
6時間近く待っても、アクションが実行されません。
なぜでしょうか？
締め切りが近いので、実行されていませんが提出させていただきました。
